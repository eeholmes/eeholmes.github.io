...
This is a forward recursion starting at t=1.  We will save the previous time step's $ \partial v_t / \theta_i $ and $ \partial F_t / \theta_i $.  That will be $2p$ ($n \times 1$) vectors and $2n$ ($n \times n$) matrices. We do not need to store all the previous time steps since this is a one-pass recursion unlike the Kalman smoother, which is forward-backward.

<br /><br />
Set-up<br/>
Number of parameters = p.<br/>
Create Iijt and oIijt which are $p \times p$ matrices.<br/>
Create dvit which is a  $n \times p$ matrix. n Innovations and p $\theta_i$.<br/>
Create d2vijt which is a  $n \times p \times p$ array. n Innovations and p $\theta_i$.<br/>
Create dFit which is a  $n \times n \times p$ array. $n \times p$ Sigma matrix and p $\theta_i$.<br/>
Create d2Fijt which is a  $n \times n \times p \times p$ array. $n \times n$ Sigma matrix and p $\theta_i$.<br/>
